...
<div class="modal fade" tabindex="-1" id="snapshotsModal">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Here is a list of all the snapshots created for this project. <span class="text-danger">MAKE THIS A
                        DATATABLE ***************</span>
                </p>
                <table id="api_user_rights_snapshots" class="table table-borderless table-hover table-sm">
                    <thead>
                        <tr>
        ...
        API_USER_RIGHTS.openSnapshotModal = function () {
            ...
            API_USER_RIGHTS.ajax('getSnapshotsInfo')
                .then(response => {
                    ...
                    const tableData = API_USER_RIGHTS.getSnapshotsTableData(response.snapshots);
                    console.log(tableData);
                    $('#api_user_rights_snapshots tbody').html(tableData);
